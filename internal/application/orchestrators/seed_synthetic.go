...
func ExecuteSeedSynthetic(ctx context.Context, deps SyntheticSeedDeps, adminAccountID string) error {
	...
	notices := []notice.Notice{
		{ID: uuid.New().String(), Type: notice.TypeSchoolWide, Status: notice.StatusPublished, Title: "Grading Day — Saturday 15 Feb", Content: "Belt grading for all eligible members. Arrive **30 min early** in clean gi.\n\n- Bring your belt\n- Trim nails\n- Water bottle required", CreatedBy: adminAccountID, PublishedBy: adminAccountID, AuthorName: "Coach Pat", ShowAuthor: true, Color: notice.ColorOrange, Pinned: true, PinnedAt: now.AddDate(0, 0, -5), CreatedAt: now.AddDate(0, 0, -5), PublishedAt: now.AddDate(0, 0, -5)},
		{ID: uuid.New().String(), Type: notice.TypeSchoolWide, Status: notice.StatusPublished, Title: "New Competition Class", Content: "Starting next week, **Tuesday & Thursday 6pm**. Open to blue belt and above.\n\nContact Coach Marcus for details.", CreatedBy: adminAccountID, PublishedBy: adminAccountID, AuthorName: "Coach Marcus", ShowAuthor: true, Color: notice.ColorBlue, CreatedAt: now.AddDate(0, 0, -3), PublishedAt: now.AddDate(0, 0, -3)},
		{ID: uuid.New().String(), Type: notice.TypeSchoolWide, Status: notice.StatusPublished, Title: "Open Mat Every Friday", Content: "Friday open mat 4-5:30pm. *All ranks welcome*. Bring water and mouthguard.", CreatedBy: adminAccountID, PublishedBy: adminAccountID, Color: notice.ColorGreen, CreatedAt: now.AddDate(0, 0, -1), PublishedAt: now.AddDate(0, 0, -1)},
		{ID: uuid.New().String(), Type: notice.TypeClassSpecific, Status: notice.StatusPublished, Title: "Kids Grading Prep", Content: "Kids grading prep this Saturday. Parents welcome to watch.", CreatedBy: adminAccountID, PublishedBy: adminAccountID, AuthorName: "Coach Pat", ShowAuthor: false, Color: notice.ColorPurple, CreatedAt: now.AddDate(0, 0, -2), PublishedAt: now.AddDate(0, 0, -2)},
		{ID: uuid.New().String(), Type: notice.TypeSchoolWide, Status: notice.StatusDraft, Title: "Gym Closure — Easter Break", Content: "Gym closed **Good Friday** through **Easter Monday**. Normal schedule resumes Tuesday.", CreatedBy: adminAccountID, Color: notice.ColorRed, CreatedAt: now},
	}
