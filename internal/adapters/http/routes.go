...
// NOTE: This file was originally generated by the scaffold tool, but it is now maintained manually.
...
func registerRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/admin/bugbox/screenshot", handleBugBoxScreenshot)
